    ...
    { 
        ...
        switch (difficulty)//Conditional 1
        {
            case 1: 
              wrongAnswerRange=30;
                do
            {
                temp1=randomIntRanged(1,100);
                temp2=randomIntRanged(1,100);
            }
        ...
        for (int x =0; x<3;x++)//Loop Structure 2
        {
            ...
            {        
                ...
                {
                    wrongAnswer=Integer.toString(Math.abs(randomIntRanged(0,wrongAnswerRange)));
                }
                else 
                {
                    wrongAnswer=Integer.toString(Math.abs(randomIntRanged(0,wrongAnswerRange)));
                ...
                {
                    if (answers[y].equals(wrongAnswer) || Integer.parseInt(wrongAnswer)<1)// Conditional 5
                    {
                        x--;
                        break;
                    }
